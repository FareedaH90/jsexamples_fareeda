...
// Printing all the columns in the second row
const e7 = array2D[2][0];   /* index row 1, index col 0: Ans: 2 */
const e8 = array2D[2][1];   /* index row 1, index col 1: Ans: 9 */
...
for (let i = 0; i < rows; i++) {
    ...
    for (let j = 0; j < cols; j++) {
        arr2D[i][j] = '░' ; //populate each row and its column with a value of zero
