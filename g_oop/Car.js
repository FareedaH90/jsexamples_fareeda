...
class Car extends Vehicle {          // INHERITS the vehicle class
    ...
    // -distanceTraveled -Encapsulaton , where the state of the property is managed by the parent class
}

// Instantiate a new instance of a Car called myNewCar

//Static method(eg. performing initiation tasks thet DOES NOT affect the class itsel)
